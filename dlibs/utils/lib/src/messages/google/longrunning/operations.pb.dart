...
class Operation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = new $pb.BuilderInfo('Operation', package: const $pb.PackageName('google.longrunning'))
    ..aOS(1, 'name')
    ..a<$1.Any>(2, 'metadata', $pb.PbFieldType.OM, $1.Any.getDefault, $1.Any.create)
    ..aOB(3, 'done')
    ..a<$2.Status>(4, 'error', $pb.PbFieldType.OM, $2.Status.getDefault, $2.Status.create)
    ..a<$1.Any>(5, 'response', $pb.PbFieldType.OM, $1.Any.getDefault, $1.Any.create)
    ..oo(0, [4, 5])
    ..hasRequiredFields = false
  ;

  Operation() : super();
  Operation.fromBuffer(List<int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Operation.fromJson(String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  set metadata($1.Any v) { setField(2, v); }
  ...
  set response($1.Any v) { setField(5, v); }
  bool hasResponse() => $_has(4);
  void clearResponse() => clearField(5);
}

class GetOperationRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = new $pb.BuilderInfo('GetOperationRequest', package: const $pb.PackageName('google.longrunning'))
    ..aOS(1, 'name')
    ..hasRequiredFields = false
  ;

  GetOperationRequest() : super();
  GetOperationRequest.fromBuffer(List<int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  GetOperationRequest.fromJson(String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static $pb.PbList<GetOperationRequest> createRepeated() => new $pb.PbList<GetOperationRequest>();
...
class ListOperationsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = new $pb.BuilderInfo('ListOperationsRequest', package: const $pb.PackageName('google.longrunning'))
    ..aOS(1, 'filter')
  ...
  ListOperationsRequest.fromBuffer(List<int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ListOperationsRequest.fromJson(String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static $pb.PbList<ListOperationsRequest> createRepeated() => new $pb.PbList<ListOperationsRequest>();
...
class ListOperationsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = new $pb.BuilderInfo('ListOperationsResponse', package: const $pb.PackageName('google.longrunning'))
  ...
  ListOperationsResponse.fromBuffer(List<int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ListOperationsResponse.fromJson(String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static $pb.PbList<ListOperationsResponse> createRepeated() => new $pb.PbList<ListOperationsResponse>();
...
class CancelOperationRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = new $pb.BuilderInfo('CancelOperationRequest', package: const $pb.PackageName('google.longrunning'))
    ..aOS(1, 'name')
    ..hasRequiredFields = false
  ;

  CancelOperationRequest() : super();
  CancelOperationRequest.fromBuffer(List<int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  CancelOperationRequest.fromJson(String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static $pb.PbList<CancelOperationRequest> createRepeated() => new $pb.PbList<CancelOperationRequest>();
...
class DeleteOperationRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = new $pb.BuilderInfo('DeleteOperationRequest', package: const $pb.PackageName('google.longrunning'))
    ..aOS(1, 'name')
    ..hasRequiredFields = false
  ;

  DeleteOperationRequest() : super();
  DeleteOperationRequest.fromBuffer(List<int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DeleteOperationRequest.fromJson(String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static $pb.PbList<DeleteOperationRequest> createRepeated() => new $pb.PbList<DeleteOperationRequest>();
...
class WaitOperationRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = new $pb.BuilderInfo('WaitOperationRequest', package: const $pb.PackageName('google.longrunning'))
    ..aOS(1, 'name')
    ..a<$3.Duration>(2, 'timeout', $pb.PbFieldType.OM, $3.Duration.getDefault, $3.Duration.create)
    ..hasRequiredFields = false
  ;

  WaitOperationRequest() : super();
  WaitOperationRequest.fromBuffer(List<int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  WaitOperationRequest.fromJson(String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  WaitOperationRequest clone() => new WaitOperationRequest()..mergeFromMessage(this);
  ...
  static $pb.PbList<WaitOperationRequest> createRepeated() => new $pb.PbList<WaitOperationRequest>();
...
class OperationInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = new $pb.BuilderInfo('OperationInfo', package: const $pb.PackageName('google.longrunning'))
    ..aOS(1, 'responseType')
    ..aOS(2, 'metadataType')
    ..hasRequiredFields = false
  ;
  ...
  OperationInfo() : super();
  OperationInfo.fromBuffer(List<int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  OperationInfo.fromJson(String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static $pb.PbList<OperationInfo> createRepeated() => new $pb.PbList<OperationInfo>();
  ...
  set responseType(String v) { $_setString(0, v); }
  bool hasResponseType() => $_has(0);
  void clearResponseType() => clearField(1);

  String get metadataType => $_getS(1, '');
  set metadataType(String v) { $_setString(1, v); }
  bool hasMetadataType() => $_has(1);
  void clearMetadataType() => clearField(2);
}

class Operations {
  static final $pb.Extension operationInfo = new $pb.Extension<OperationInfo>('google.protobuf.MethodOptions', 'operationInfo', 1049, $pb.PbFieldType.OM, OperationInfo.getDefault, OperationInfo.create);
