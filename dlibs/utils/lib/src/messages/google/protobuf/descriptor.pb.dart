...
class FileOptions extends $pb.GeneratedMessage {
  ...
  bool get phpGenericServices => $_get(8, false);
  set phpGenericServices(bool v) { $_setBool(8, v); }
  bool hasPhpGenericServices() => $_has(8);
  void clearPhpGenericServices() => clearField(19);

  bool get javaGenerateEqualsAndHash => $_get(9, false);
  set javaGenerateEqualsAndHash(bool v) { $_setBool(9, v); }
  bool hasJavaGenerateEqualsAndHash() => $_has(9);
  void clearJavaGenerateEqualsAndHash() => clearField(20);

  bool get deprecated => $_get(10, false);
  set deprecated(bool v) { $_setBool(10, v); }
  bool hasDeprecated() => $_has(10);
  void clearDeprecated() => clearField(23);

  bool get javaStringCheckUtf8 => $_get(11, false);
  set javaStringCheckUtf8(bool v) { $_setBool(11, v); }
  bool hasJavaStringCheckUtf8() => $_has(11);
  void clearJavaStringCheckUtf8() => clearField(27);

  bool get ccEnableArenas => $_get(12, false);
  set ccEnableArenas(bool v) { $_setBool(12, v); }
  bool hasCcEnableArenas() => $_has(12);
  void clearCcEnableArenas() => clearField(31);

  String get objcClassPrefix => $_getS(13, '');
  set objcClassPrefix(String v) { $_setString(13, v); }
  bool hasObjcClassPrefix() => $_has(13);
  void clearObjcClassPrefix() => clearField(36);

  String get csharpNamespace => $_getS(14, '');
  set csharpNamespace(String v) { $_setString(14, v); }
  bool hasCsharpNamespace() => $_has(14);
  void clearCsharpNamespace() => clearField(37);

  String get swiftPrefix => $_getS(15, '');
  set swiftPrefix(String v) { $_setString(15, v); }
  bool hasSwiftPrefix() => $_has(15);
  void clearSwiftPrefix() => clearField(39);

  String get phpClassPrefix => $_getS(16, '');
  set phpClassPrefix(String v) { $_setString(16, v); }
  bool hasPhpClassPrefix() => $_has(16);
  void clearPhpClassPrefix() => clearField(40);

  String get phpNamespace => $_getS(17, '');
  set phpNamespace(String v) { $_setString(17, v); }
  bool hasPhpNamespace() => $_has(17);
  void clearPhpNamespace() => clearField(41);

  List<UninterpretedOption> get uninterpretedOption => $_getList(18);
}
