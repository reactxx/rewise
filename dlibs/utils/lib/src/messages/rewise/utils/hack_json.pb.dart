...
class HackJsonString extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = new $pb.BuilderInfo('HackJsonString', package: const $pb.PackageName('rewiseDom'))
...
class HackJsonBytes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = new $pb.BuilderInfo('HackJsonBytes', package: const $pb.PackageName('rewiseDom'))
    ..aOS(1, 'qualifiedMessageName')
