...
class Pools {
  ...
  Future runFilerServer() async {
    Future poolWrite(String lang, String text, par) async {
      ...
      try {
        final file = File('c:\\temp\\$lang.txt').openSync(mode: FileMode.writeOnlyAppend);
        try {
    ...
    await for (final msg in receivePort) poolWrite(msg[0], msg[1], msg[2]);
