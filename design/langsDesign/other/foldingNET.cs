...
public static class NETFolding {
  public static int toLower(UInt16 ch) {
    ...
    if (ch >= 7944 && ch <= 7951 || ch >= 7960 && ch <= 7965 || ch >= 7976 && ch <= 7983 || ch >= 7992 && ch <= 7999 || ch >= 8008 && ch <= 8013 || ch >= 8040 && ch <= 8047 || ch >= 8120 && ch <= 8121 || ch >= 8152 && ch <= 8153 || ch >= 8168 && ch <= 8169) return ch + -8;
