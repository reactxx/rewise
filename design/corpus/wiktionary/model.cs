...
namespace WiktModel {
  ...
  public partial class Entry : Helper {
    ...
    public byte PartOfSpeech { get; set; } // lexinfo:partOfSpeech (excluded lexinfo:partOfSpeech=ontolex:LexicalEntry), ignored dbnary:partOfSpeech

    // Q: canonical-form-sh, canonical-form, entry-writtenRep
    public string WrittenRep { get; set; } // for SH: ontolex:writtenRep. Else ontolex:canonicalForm.ontolex:writtenRep

    //public WiktConsts.hasNumber hasNumber;
    ...
    //public WiktConsts.hasGender gender; // lexinfo:gender
