...
namespace WiktModel {
  ...
  public partial class Entry : Helper {
    ...
    public byte HasCountability; // olia:hasCountability
    ...
    //public byte HasInflectionType; // olia:hasInflectionType

    // for lexinfo:verb and lexinfo:participle: UriValues[olia:Separable,olia:NonSeparable]
    // ignore, 273x only
    //public byte HasSeparability; // olia:hasSeparability - @olia,
    ...
    //public string LexicalRel; // vartrans:lexicalRel
  }
