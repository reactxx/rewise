...
public static class WiktConsts {
  ...
  public static string[] FinalDBTypes = new string[] { NodeTypeNames.LexicalSense, NodeTypeNames.Page, NodeTypeNames.Statement };
  ...
  public enum predicates {
    ...
    dbnary_rank, dbnary_senseNumber, dbnary_synonym, dbnary_troponym, dbnary_targetLanguage, dbnary_targetLanguageCode, dbnary_usage, dbnary_writtenForm, lexinfo_animacy,
  ...
  internal static Dictionary<predicates, PredicateType> predicateTypes = new Dictionary<predicates, PredicateType> {
    ...
    { predicates.dbnary_troponym, PredicateType.NymRelProps},
